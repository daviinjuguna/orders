...
class _$_OrderModel extends _OrderModel {
  ...
  @override
  String toString() {
    return 'OrderModel(id: $id, user: $user, products: $products, date: $date, amount: $amount)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, user,
      const DeepCollectionEquality().hash(_products), date, amount);
...
abstract class _OrderModel extends OrderModel {
  const factory _OrderModel(
      ...
      required final double amount}) = _$_OrderModel;
